...
import org.uhafactory.test.tour.program.QProgram;
...
public class RegionRepositoryImpl extends QuerydslRepositorySupport implements RegionRepositoryCustom {
    ...
    @Override
    public List<DescriptionKeywordResult.RegionAndProgramCount> findByProgramInContainsDescriptionKeyword(String keyword) {
        return from(QRegion.region)
                ...
                .select(Projections.constructor(DescriptionKeywordResult.RegionAndProgramCount.class,
